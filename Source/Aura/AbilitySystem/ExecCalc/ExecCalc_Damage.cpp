	...
	FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	float Damage = 0.f;
	for (const auto& [DamageTypeTag, DamageResistanceTag] : FAuraGameplayTags::Get().DamageTypesToResistances)
	{
	...
	const float CriticalHitResistanceCoeff = CriticalHitResistanceCurve->Eval(SourceCombatInterface->GetPlayerLevel());
